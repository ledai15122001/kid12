...
const milestones: Milestone[] = [
  {
    ...
    body: 'Con viết đoạn văn có cấu trúc, đọc hiểu các bài dài hơn và bắt đầu làm quen với tư duy phân tích bằng tiếng Anh.',
  ...
  },
  {
    num: '13-14 tuổi',
    title: 'Phát triển',
    body: 'Con viết luận hoàn chỉnh, biết tranh luận và bảo vệ quan điểm bằng tiếng Anh trước lớp một cách tự tin.',
  ...
  },
  {
    num: '15 tuổi',
    title: 'Sẵn sàng',
    body: 'Con đủ nền tảng để luyện thi các chứng chỉ quốc tế nếu có định hướng, tự tin dùng tiếng Anh trong học tập và cuộc sống.',
