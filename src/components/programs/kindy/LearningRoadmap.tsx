...
const milestones: Milestone[] = [
  {
    num: '3 tuổi',
    title: 'Làm quen',
    body: 'Con làm quen với âm thanh tiếng Anh qua bài hát và trò chơi đơn giản, không áp lực, chỉ có niềm vui.',
  ...
  },
  {
    num: '4 tuổi',
    title: 'Khám phá',
    body: 'Con nhận biết từ vựng quen thuộc, bắt đầu ghép câu ngắn và phản xạ trả lời cô bằng tiếng Anh.',
  ...
  },
  {
    num: '5 tuổi',
    title: 'Tự tin',
    body: 'Con tự tin chào hỏi, giới thiệu bản thân và kể một câu chuyện ngắn hoàn toàn bằng tiếng Anh.',
      ...
      <div className="container-page relative">
        ...
        <div className="flex flex-col items-start gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <p className="max-w-sm font-body text-base leading-relaxed text-ink-600 lg:text-right">
            Mỗi độ tuổi là một cột mốc phát triển riêng - con tiến bộ tự nhiên,
